...
- (void)hasUpdateVersion{
    ...
    //apikey，appkey
    NSDictionary *paramDic = @{@"_api_key":@"d98734ffcbcb99a86ff217e63c46ecfe",@"appKey":@"0dea9e824b4a259c5ae2079f821d72d3"};
...
//    }
    ...
    __weak typeof(self)weakself = self;
    UIAlertController *ac = [UIAlertController alertControllerWithTitle:@"" message:@"切换机构会删除数据，确定重新选择机构！"  preferredStyle:UIAlertControllerStyleAlert];
...
- (void)deleteAllData{
    ...
    [self deleteRecordAllDocuments:@"Project"];
    [self deleteRecordAllDocuments:@"Task"];
    [self deleteRecordAllDocuments:@"AtonementNotice"];
    ...
    [self deleteRecordAllDocuments:@"CaseServiceFiles"];
    [self deleteRecordAllDocuments:@"CaseServiceReceipt"];
    [self deleteRecordAllDocuments:@"Citizen"];
    [self deleteRecordAllDocuments:@"RoadWayClosed"];
    [self deleteRecordAllDocuments:@"Inspection"];
    [self deleteRecordAllDocuments:@"InspectionCheck"];
    [self deleteRecordAllDocuments:@"InspectionOutCheck"];
    [self deleteRecordAllDocuments:@"InspectionPath"];
    [self deleteRecordAllDocuments:@"InspectionRecord"];
    [self deleteRecordAllDocuments:@"ParkingNode"];
    [self deleteRecordAllDocuments:@"CaseMap"];
    [self deleteRecordAllDocuments:@"ConstructionChangeBack"];
    ...
    [self deleteRecordAllDocuments:@"MaintainCheckDaily"];
    [self deleteRecordAllDocuments:@"RectificationNotice"];
    [self deleteRecordAllDocuments:@"StopNotice"];
    [self deleteRecordAllDocuments:@"RoadWayClosed"];
    [self deleteRecordAllDocuments:@"CaseLawInfo"];
    [self deleteRecordAllDocuments:@"ServiceManage"];
    [self deleteRecordAllDocuments:@"ServiceManageDetail"];
    [self deleteRecordAllDocuments:@"HelpWork"];
    [self deleteRecordAllDocuments:@"CarCheckRecords"];
    [self deleteRecordAllDocuments:@"CheckInstitutions"];
    [self deleteRecordAllDocuments:@"RoadAsset_Check_Main"];
    [self deleteRecordAllDocuments:@"RoadAsset_Check_detail"];
    [self deleteRecordAllDocuments:@"BridgeSpaceCheckSpecialB"];
    [self deleteRecordAllDocuments:@"BridgeSpaceCheckSpecial"];
    [self deleteRecordAllDocuments:@"MaintainCheckSpecial"];
    [self deleteRecordAllDocuments:@"MaintainCheckSpecialScence"];
    [self deleteRecordAllDocuments:@"MaintainCheckSpecialTrafficSecurityFacility"];
    [self deleteRecordAllDocuments:@"MaintainCheckSpecialFinish"];
    [self deleteRecordAllDocuments:@"MaintainCheckSpecialControlArea"];
    [self deleteRecordAllDocuments:@"MaintainCheckSpecialJob"];
    [self deleteRecordAllDocuments:@"MaintainCheckDaily"];
    [self deleteRecordAllDocuments:@"RescueRecord"];
    [self deleteRecordAllDocuments:@"InspectionTotal"];
