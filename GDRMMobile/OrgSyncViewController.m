...
- (IBAction)setCurrentOrg:(UIBarButtonItem *)sender{
    ...
    if (indexPath) {
        ...
        self.dataDownLoader = [[DataDownLoad alloc] init];
...
//    __weak typeof(self)weakself = self;
//    UIAlertController *ac = [UIAlertController alertControllerWithTitle:@"消息" message:@"下载完毕"  preferredStyle:UIAlertControllerStyleAlert];
