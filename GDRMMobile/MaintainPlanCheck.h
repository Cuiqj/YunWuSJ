...
@property (nonatomic, retain) NSString * maintainPlan_id;        //施工项目id
...
//@property (nonatomic,retain) NSString * check_project_id;
//@property (nonatomic,retain) NSString * check_danwei;
