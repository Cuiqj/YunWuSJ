...
- (IBAction)saveBtn:(id)sender {
    ...
    inspectionRecord.remark=[NSString stringWithFormat:@"%@ 当班人员开展“青春足迹.丈量沿海”，徒步检查%@%@K%02ld+%03ldM至K%02ld+%03ldM路产设施、桥下空间及控制区，%@",timeString,self.textRoad.text,self.textSide.text,[self.textSKM.text integerValue],[self.textSM.text integerValue],[self.textEKM.text integerValue],[self.textEM.text integerValue],self.textRemark.text];
