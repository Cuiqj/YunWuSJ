...
@property (weak, nonatomic) IBOutlet UITextField *textservicename;    //被考核单位名称
@property (weak, nonatomic) IBOutlet UITextField *textservice_fuzeren;  //被检查单位负责人
@property (weak, nonatomic) IBOutlet UITextField *textcheck_fuzeren;   //检查负责人
