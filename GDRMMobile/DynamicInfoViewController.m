...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    self.textStartKM.text=[NSString stringWithFormat:@"%02d",closeInfo.station_start.integerValue/1000];
    self.textStartM.text=[NSString stringWithFormat:@"%03d",closeInfo.station_start.integerValue%1000];
    self.textEndKM.text=[NSString stringWithFormat:@"%02d",closeInfo.station_end.integerValue/1000];
    self.textEndM.text=[NSString stringWithFormat:@"%03d",closeInfo.station_end.integerValue%1000];
