...
- (void)saveCaseProveInfoForCase:(NSString *)caseID{
    ...
    if (station_start.integerValue == 0 || station_start.integerValue == station_end.integerValue  ) {
        stationString=[NSString stringWithFormat:@"K%02ld+%03ldM",self.textStationStartKM.text.integerValue,self.textStationStartM.text.integerValue];
    } else {
        stationString=[NSString stringWithFormat:@"K%02ld+%03ldM至K%02ld+%03ldM",self.textStationStartKM.text.integerValue,self.textStationStartM.text.integerValue,self.textStationEndKM.text.integerValue,self.textStationEndM.text.integerValue];
    }
    //以前的勘验场所描述
